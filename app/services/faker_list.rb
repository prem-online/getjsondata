...
require 'faker'
    ...
    def get_data(data_class,quantity)
        met0_classes = [
            "Name","Alphanumeric", "Ancient", "App", "Appliance", "Artist", "Bank", "Barcode",
            "Beer", "Blood", "Book", "Books", "Boolean", "Business", "Camera", "Code", "Coffee",
            "Coin", "Computer", "Construction", "Cosmere", "Currency", "Demographic", "Dessert",
            "Device", "Educator", "Emotion", "Esport", "Finance", "Food", "Game", "Gender",
            "Hipster", "Hobby", "House", "Job", "Json", "Kpop", "Markdown", "Marketing",
            "Measurement", "Military", "Mountain", "Movie", "Music", "Name", "Nation", 
            "Number", "Quote", "Relationship", "Restaurant", "Science", "Show", "Space",
            "Sport", "Subscription", "Superhero", "Tea", "Team", "Time", "University", "Verb",]
